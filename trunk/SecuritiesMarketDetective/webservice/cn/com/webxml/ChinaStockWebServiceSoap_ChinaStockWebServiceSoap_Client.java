...
public final class ChinaStockWebServiceSoap_ChinaStockWebServiceSoap_Client {
	...
	public static void main(String args[]) throws java.lang.Exception {
		 ...
		 * byte[] _getStockImageByteByCode__return =
		 * port.getStockImageByteByCode(_getStockImageByteByCode_theStockCode);
		 ...
		 * byte[] _getStockImageKByteByCode__return =
		 * port.getStockImageKByteByCode(_getStockImageKByteByCode_theStockCode, _getStockImageKByteByCode_theType);
		 ...
		 */
		{
			...
			java.lang.String _getStockInfoByCode_theStockCode = "sh000001";
			cn.com.webxml.ArrayOfString _getStockInfoByCode__return = port.getStockInfoByCode(_getStockInfoByCode_theStockCode);
			List<String> strings = _getStockInfoByCode__return.getString();
